...
export const rosaryOriginSections = [
	{
...
export const rosaryHowToSteps = [
	{
		"number": 1,
		"title": "Begin with the Sign of the Cross",
		"description": "Hold the crucifix and pray: “In the name of the Father, and of the Son, and of the Holy Spirit. Amen.”"
	},
	{
		"number": 2,
	...
	},
	{
		...
		"description": "On the first large bead, pray one Our Father. On the next three small beads, pray a Hail Mary on each—for an increase of faith, hope, and charity. Then pray the Glory Be."
	},
	{
		"number": 4,
		"title": "Announce the first mystery",
		"description": "Name the mystery you will meditate on (for example, “The First Joyful Mystery: The Annunciation”). Many Catholics also state the fruit of the mystery. Choose the set for the day (see below)."
	},
	{
		"number": 5,
		"title": "Pray one decade",
		"description": "On the large bead before the decade: one Our Father. On each of the ten small beads: one Hail Mary, meditating on the mystery. After the tenth Hail Mary: Glory Be, and optionally the Fatima Prayer (“O my Jesus…”)."
	},
	{
		"number": 6,
		"title": "Continue through five decades",
		"description": "Before each new decade, announce the next mystery, then repeat step 5. A full Rosary is five decades—one for each mystery in the set you are praying that day."
	},
	{
		"number": 7,
		"title": "Close with the Hail Holy Queen",
		"description": "After the fifth decade, pray the Hail Holy Queen and the concluding prayer. You may end with the Sign of the Cross. Some add the Prayer to St. Michael or other customary prayers."
	}
];
