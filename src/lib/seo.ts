export const SITE = {
	...
	defaultDescription:
		'Learn about Catholic saints, the sacraments, miracles and parables of Jesus, the Ten Commandments, the Mysteries of the Rosary, and the faith. Clear teaching for prayer, formation, and knowledge sharing.',
	keywords:
		'Catholic, saints, sacraments, miracles of Jesus, parables of Jesus, Gospels, Ten Commandments, rosary, mysteries of the rosary, faith, catechism, biography, Digital Catholic, Christian',
	locale: 'en_US',
	themeColor: '#6b2d3c',
